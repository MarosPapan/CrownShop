...
class CheckoutView(View):
    def get(self, args, **kwargs):
        try:
            ...
            message.info(self.request, "You don't have any order")
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        print('STRIPE DATA: ', self.request.POST)
        ...
        try:
            ...
            # yourself an email
            messages.error(self.request, "Somenthing went wrong. You were not charged. Please try again.")
            return redirect("/")
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            return redirect("shop:ItemDetailView", slug=slug)
    else:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            try:
                ...
                messages.info(self.request, "You don't have any order")
                return redirect('shop:Checkout')
...
class RequestRefundView(View):
    def get(self, *args, **kwargs):
        ...
        return render(self.request, "shop/requestRefund.html", context)
